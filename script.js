...
function checkCoachDismissal() {\n    const status = getCoachDismissalStatus();\n    if (!status) return false;\n    showCoachDismissal(status);\n    return true;\n}\nfunction renderRound(round) {
    ...
    if (actions && window.__coachDismissed) {
        actions.innerHTML = `<div class="season-finished-note">GRA ZAKOŃCZONA — TRENER ZWOLNIONY</div>`;
        return;
    }
...
function renderFinalSeason() {
    ...
    // W trybie TRENER sprawdzamy warunek zwolnienia po zakończeniu sezonu.
